...
/* Line 268 of yacc.c  */
#line 149 "objects/prod/dnsextd_parser.c"
...
/* Line 293 of yacc.c  */
#line 222 "objects/prod/dnsextd_parser.c"
} YYSTYPE;
...
/* Line 343 of yacc.c  */
#line 234 "objects/prod/dnsextd_parser.c"
...
{
       0,     0,     3,     4,     8,    10,    12,    14,    17,    21,
      22,    26,    28,    31,    36,    40,    46,    50,    54,    62,
      66,    71,    75,    76,    80,    83,    86,    89,    92,    96,
      97,   101,   103,   107,   108,   112,   115,   117,   119,   121,
     126,   127,   130,   132
};
...
{
      32,     0,    -1,    -1,    32,    33,    23,    -1,    34,    -1,
      39,    -1,    38,    -1,     3,    35,    -1,    21,    36,    22,
      -1,    -1,    36,    37,    23,    -1,    51,    -1,     4,    43,
      -1,     4,     6,    30,    43,    -1,     5,     7,    49,    -1,
       5,     7,    49,     6,    30,    -1,    10,     6,    30,    -1,
       8,     6,    30,    -1,    13,    29,    21,    15,    29,    23,
      22,    -1,    18,    29,    40,    -1,    18,    29,    24,    40,
      -1,    21,    41,    22,    -1,    -1,    41,    42,    23,    -1,
      19,     9,    -1,    19,    10,    -1,    11,    46,    -1,    12,
      46,    -1,    21,    44,    22,    -1,    -1,    44,    45,    23,
      -1,    25,    -1,    21,    47,    22,    -1,    -1,    47,    48,
      23,    -1,    13,    27,    -1,    25,    -1,    28,    -1,    26,
      -1,    21,    41,    22,    23,    -1,    -1,    51,    52,    -1,
      50,    -1,    29,    -1
};
...
#line 187 "../mDNSShared/dnsextd_parser.y"
    {
			( ( DaemonInfo* ) context )->private_port = mDNSOpaque16fromIntVal( (yyvsp[(3) - (3)].number) );
		}
    break;
...
#line 192 "../mDNSShared/dnsextd_parser.y"
    {
			( ( DaemonInfo* ) context )->llq_port = mDNSOpaque16fromIntVal( (yyvsp[(3) - (3)].number) );
		}
    break;
...
#line 199 "../mDNSShared/dnsextd_parser.y"
    {
			...
			strncpy( keySpec->name, (yyvsp[(2) - (7)].string), sizeof( keySpec->name ) );
			strncpy( keySpec->secret, (yyvsp[(5) - (7)].string), sizeof( keySpec->secret ) );
...
#line 220 "../mDNSShared/dnsextd_parser.y"
    {
			...
			strncpy( zoneSpec->name, (yyvsp[(2) - (3)].string), sizeof( zoneSpec->name ) );
...
#line 242 "../mDNSShared/dnsextd_parser.y"
    {
			...
			strncpy( zoneSpec->name, (yyvsp[(2) - (4)].string), sizeof( zoneSpec->name ) );
			zoneSpec->type = g_zoneSpec.type;
			strcpy( zoneSpec->key, g_zoneSpec.key );
			zoneSpec->allowUpdate = g_zoneSpec.allowUpdate;
			zoneSpec->allowQuery = g_zoneSpec.allowQuery;
...
/* Line 1806 of yacc.c  */
#line 1776 "objects/prod/dnsextd_parser.c"
      default: break;
    }
